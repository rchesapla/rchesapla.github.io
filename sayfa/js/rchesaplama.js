...
function blockAmount() {
    ...
    switch (document.getElementById("block-type").selectedIndex) {
        case 0:
            //Bitcoin - 28000
            var blockreward = 25000;
            document.getElementById("block-reward").value = 25000;
        ...
        case 1:
            //Doge - 60
            var blockreward = 173;
            document.getElementById("block-reward").value = 173;
			document.getElementById("exp_reward").innerHTML = "【Önce Hesapla】";
			document.getElementById("daily").innerHTML = "【Önce Hesapla】";
			document.getElementById("weekly").innerHTML = "【Önce Hesapla】";
			document.getElementById("monthly").innerHTML = "【Önce Hesapla】";
        ...
        case 2:
            //Eth - 0.0055
            var blockreward = 0.0025;
            document.getElementById("block-reward").value = 0.0025;
			document.getElementById("exp_reward").innerHTML = "【Önce Hesapla】";
			document.getElementById("daily").innerHTML = "【Önce Hesapla】";
			document.getElementById("weekly").innerHTML = "【Önce Hesapla】";
			document.getElementById("monthly").innerHTML = "【Önce Hesapla】";
        ...
        case 3:
            //Bnb - 0.025
            var blockreward = 0.027;
            document.getElementById("block-reward").value = 0.027;
			document.getElementById("exp_reward").innerHTML = "【Önce Hesapla】";
			document.getElementById("daily").innerHTML = "【Önce Hesapla】";
			document.getElementById("weekly").innerHTML = "【Önce Hesapla】";
			document.getElementById("monthly").innerHTML = "【Önce Hesapla】";
        ...
        case 5:
            //SOL - 0.06
            var blockreward = 0.10;
            document.getElementById("block-reward").value = 0.10;
			document.getElementById("exp_reward").innerHTML = "【Önce Hesapla】";
			document.getElementById("daily").innerHTML = "【Önce Hesapla】";
			document.getElementById("weekly").innerHTML = "【Önce Hesapla】";
			document.getElementById("monthly").innerHTML = "【Önce Hesapla】";
		...
		case 6:
            //TRX - 60
            var blockreward = 85;
            document.getElementById("block-reward").value = 85;
			document.getElementById("exp_reward").innerHTML = "【Önce Hesapla】";
			document.getElementById("daily").innerHTML = "【Önce Hesapla】";
			document.getElementById("weekly").innerHTML = "【Önce Hesapla】";
			document.getElementById("monthly").innerHTML = "【Önce Hesapla】";
